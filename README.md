...
[LeetCode](https://leetcode.com/) Solutions are only in Python

| # | Title |Soluion|  Difficulty |
|---| ----- |-----| ---------- |
...
|028|[Find the Index of the First Occurrence in a String](https://leetcode.com/problems/find-the-index-of-the-first-occurrence-in-a-string/)|[Python](./Python/028.md)|Easy|
